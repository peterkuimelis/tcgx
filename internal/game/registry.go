...
var CardRegistry = map[string]func() *Card{
	...
	"Frostbite Tyrant":                  FrostbiteTyrant,
	"Plasma Arc Tyrant":                 PlasmaArcTyrant,
	"Thermal Spike":                     ThermalSpike,
	"Fenrir Mk.II":                      FenrirMkII,
	"Amphibious Mech MK-3":              AmphibiousMechMK3,
	"Siren Enforcer":                    SirenEnforcer,
	"Abyssal Circuit Leviathan":         AbyssalCircuitLeviathan,
	"Chromeborne Hydra Nexus":           ChromeborneHydraNexus,
